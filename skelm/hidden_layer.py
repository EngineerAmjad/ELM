...
class DenseSLFN:
    def __init__(self, weights,n_neurons, ufunc):
        self.W = weights
        self.ufunc = ufunc
...
class HiddenLayer(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, n_neurons=None, density=None, ufunc="tanh", pairwise_metric=None, weights=None,random_state=None):
        self.n_neurons = n_neurons
    ...
    def fit(self, X, y=None):
        ...
        if self.pairwise_metric is not None:
            ...
            self.SLFN_ = DenseSLFN(self.weights, self.n_neurons_,self.ufunc_)
